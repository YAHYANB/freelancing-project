const PayModal = ({ isOpen, children, onClose }) => {
    if (!isOpen) return null;

    return (
        <div className="fixed bg-opacity-25 inset-0 z-50 flex justify-center items-center">
            <div className="bg-white p-4 md:w-1/2 w-full rounded-lg shadow-md">
